...
from ..hardware import initializer  # (если используются функции из этого модуля)
from ..sensors.accelerometer.mpu6050 import MPU6050
from ..sensors.current.adc import init_adc, calibrate_current_sensors, AnalogIn
